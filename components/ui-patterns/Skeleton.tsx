...
const HackathonCardSkeleton: React.FunctionComponent<SkeletonType> = ({
  ...
  return (
    <React.Fragment>
      <div className="hackathon-card-skeleton w-[280px] h-[320px] flex flex-col border border-white hover:scale-105 transition-all items-center justify-end">
...
const SessionCardSkeleton: React.FunctionComponent<SkeletonType> = ({
  ...
  return (
    <React.Fragment>
      <div className="session-card-skeleton w-[280px] h-[320px] flex flex-col border border-product-brown hover:scale-105 transition-all items-center justify-end">
        <div className="session-card-skeleton-cover-image-wrapper h-full w-full border-b border-product-brown px-4 py-6">
...
const CommunityNarrativesCardSkeleton: React.FunctionComponent<
  SkeletonType
> = ({ visibility }) => {
  return (
    <React.Fragment>
